...
import com.example.bonusexercise4.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private fun highlightButton(index: Int) {
        when (index) {
            0 -> binding.greenButton.backgroundTintList =
                ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.hiGreen))
            ...
            2 -> binding.yellowButton.backgroundTintList =
                ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.hiYellow))
    ...
    private fun resetColors() {
        ...
        val redList = ContextCompat.getColorStateList(requireContext(), R.color.red_button_colors)
        val yellowList =
