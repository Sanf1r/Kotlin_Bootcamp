...
import com.example.bonusexercise5.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private fun setupStateList() {
        if (lightFlag) {
            greenList =
                ContextCompat.getColorStateList(requireContext(), R.color.green_button_colors_no_light)!!
            redList = ContextCompat.getColorStateList(requireContext(), R.color.red_button_colors_no_light)!!
            yellowList =
                ContextCompat.getColorStateList(requireContext(), R.color.yellow_button_colors_no_light)!!
            blueList =
                ContextCompat.getColorStateList(requireContext(), R.color.blue_button_colors_no_light)!!
        } else {
            greenList =
